...
export default function ComponentResultExplorer({
  enrichedResult,
  onComponentSelect,
}: ComponentResultExplorerProps) {
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <div>
                      ...
                      <div className="text-xs">
                        {new Date(component.startDate).toLocaleString()}
                      </div>
                    </div>
                    <div>
                          ...
                          component.detectedFormat ? (
                            <span className="flex items-center gap-1">
                              ...
                              <span className="text-muted-content">
                                ({Math.round(component.detectedFormat.confidence * 100)}%
                                confidence)
                              </span>
                            </span>
                          ) : (
