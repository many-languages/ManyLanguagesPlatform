...
import type { StudySummaryResult } from "@/src/features/studies/domain/inspector/calculateStudySummary"
...
export default function StudySummary({ summary }: StudySummaryProps) {
  if (!summary) {
    return (
      <div className="mt-4">
        <EmptyState
